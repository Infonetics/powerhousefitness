		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.php">Architect</a></div>
						</div>
				...
				<div class="row row-pb-md">
					...
					<div class="col-md-3 col-md-push-1">
						...
						<ul class="colorlib-footer-links">
							...
							<li><a href="http://luxehotel.com"><i class="icon-location4"></i> altomoohts.com</a></li>
						</ul>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 text-center">
						<p>
     					...
     					<small class="block">Copyright &copy; <script>document.write(new Date("Y").getFullYear());</script> All rights reserved.  <br>This template is made with <i class="icon-heart3" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Infonetics Technologies</a></small>
    					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
					</div>
				</div>
