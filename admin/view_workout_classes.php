...
if(isset($_POST['update']))
 ...
 //echo "<pre>";print_r($_POST); exit;
        // include("image_validation.php");
            ...
            $ql= "UPDATE `".DB_PREFIX."`.`tbl_workout_classes` SET `title`= '".trim($title)."',`short_desc`= '".trim(addslashes($short_description))."',`image`='".trim($image)."',`last_modified`=NOW() WHERE `workout_classes_id`='$workout_classes_id'";
            //echo $ql;exit;
...
?>
                   <?php 
                                          ...
                                          $sql = "SELECT * FROM `".DB_PREFIX."`.`tbl_workout_classes`";
