          ...
          <div class="card shadow">
            ...
            // echo "<pre>";print_r($response);exit;
               ...
               else
               {
                    ...
                    $sql="UPDATE `".DB_PREFIX."`.`tbl_manage_about`  SET `aboutus_content` ='$aboutus_content',`video_bg_image`='$video_bg_image',`video`='$video',`image1`='$image1',`image2`='$image2',`image3`='$image3' WHERE `manage_about_id`=1";
                   //echo  $sql;exit;
...
$que="select * from `".DB_PREFIX."`.`tbl_manage_about`";
$query=$con->query($que);
