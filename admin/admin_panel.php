...
if(isset($_POST["btn_web"]))
{
          ...
          if($response['type'] == 'error'){
              ...
              $q1="UPDATE `".DB_PREFIX."`.`admin_panel` SET `title`='$title',`short_title`='$short_title',`logo`='$website_logo',`currency_code`= '$currency_code'";
...
$que="select * from `".DB_PREFIX."`.`admin_panel`";
$query=$con->query($que);
