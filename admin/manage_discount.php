...
<body class="">
  ...
  <div class="main-content">
      ...
      <div class="row">
        <div class="col">
          <div class="card shadow">
            ...
            {
            	 extract($_POST);
                $sql="INSERT INTO `".DB_PREFIX."`.`tbl_discount` (`discount_name`,`discount_rate`,`created_on`) values ('".trim($discount_name)."','".trim($discount_rate)."', NOW() )";
	             //echo $sql;exit;
	...
	if(isset($_POST['update']))
      {
      extract($_POST);
      $ql= "UPDATE `".DB_PREFIX."`.`tbl_discount` SET `discount_name`= '".trim($discount_name_up)."',`discount_rate`= '".trim($discount_rate_up)."' WHERE `discount_id`='$discount_id'";
            //echo $ql;exit;
