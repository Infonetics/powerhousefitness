  ...
  <div class="main-content">
		      ...
		      // echo "<pre>";print_r($_POST); 
               ...
               // echo "hhbdsf";
                    ...
                    if($relieved_date=='')
                    {
                      ...
                      $ql= "UPDATE `tbl_trainer` SET `fname`= '".trim($firstname)."',`lname`= '".trim($lastname)."',`email`='".trim($email)."',`contact`='".trim($contact)."',`dob`='".trim($dob)."',`age`='".trim($age)."',`gender`='".trim($gender)."',
                      `married_status`='".trim($married_status)."',`address`='".trim(addslashes($address))."',`feet`='".trim($feet)."',`inches`='".trim($inches)."',`weight`='".trim($weight)."',`designation`='".trim($designation)."',`description`='".trim(addslashes($description))."',`joined_date`='".trim($joined_date)."',`relieved_date`='".trim($relieved_date)."',`image`='".trim($image)."',`sort_order`='".trim($sort_order)."' WHERE `trainer_id`='$trainer_id' ";
                      // echo $ql;exit;
	...
	?>
                   <?php 
                                          ...
                                          $sql = "SELECT * FROM tbl_trainer WHERE 1 ORDER BY sort_order ASC";
                                      ...
                                      <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="insert_form">
                                          <div class="form-group">
                                              <div class="row">
                                                  ...
                                                  <div class="col-sm-4">
                                                      <input type="text" placeholder="Firstname"  name="firstname"  id="firstname" class="form-control" onkeypress="return isAlfa(event)" required>
                                                  </div>
                                                  <label class="col-sm-2 control-label">Lastname</label>
                                                  <div class="col-sm-4">
                                                      <input type="text" placeholder="Lastname" name="lastname" id="lastname" class="form-control" onkeypress="return isAlfa(event)" required>
                                                  </div>
                                              </div>
                                          </div>
                                          <!--  <div class="form-group">
                                           ...
                                           <div class="form-group">
                                              <div class="row">
                                                  ...
                                                  <div class="col-sm-4">
                                                      <input type="text" placeholder="Contact No." name="contact" id="contact"  maxlength="13" class="form-control" onkeypress="return isNumber(event)" required>
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="form-group">
                                              <div class="row">
                                                  ...
                                                  <div class="col-sm-4">
                                                      <input type="text" placeholder="Age" name="age" id="age" class="form-control" required readonly>
                                                  </div>
                                              </div>
                                          </div> 
                                           <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <div class="row">
                                                  <label class="col-sm-2 control-label">Feet</label>
                                                  <div class="col-sm-2">
                                                        <input type="text" placeholder="Feet" name="feet" id="feet" onkeypress="return isNumber(event)" class="form-control" required>
                                                  </div>
                                                  <label class="col-sm-2 control-label">Inches</label>
                                                  <div class="col-sm-2">
                                                        <input type="text" placeholder="Inches" name="inches" id="inches" onkeypress="return isNumber(event)" class="form-control" required>
                                                  </div>
                                                  <label class="col-sm-2 control-label">Weight</label>
                                                  <div class="col-sm-2">
                                                        <input type="text" placeholder="Weight" name="weight" id="weight" onkeypress="return isNumber(event)" class="form-control" required>
                                                  </div>
                                              </div>
                                          </div> 
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <div class="row">
                                                  ...
                                                  <div class="col-sm-4">
                                                      <input class="form-control" type="date" placeholder="DD/MM/YY"  name="joined_date" id="joined_date"  required>
                                                  </div>
                                                  <label class="col-sm-2 control-label">Date Of Relieving</label>
                                                  <div class="col-sm-4">
                                                      <input class="form-control" type="date" placeholder="DD/MM/YY" name="relieved_date" id="relieved_date" >
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                   <input class="form-control" type="text" placeholder="Sort Order" id="sort_order" name="sort_order">
                                                </div>
                                            </div>
                                        </div>
                                           <div class="form-group">
