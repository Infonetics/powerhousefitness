              ...
              <div class="row icon-examples">
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" style="margin:auto;width:60%;">
                  <div class="form-group">
                    <div class="row">
                      <label class="col-md-4 control-label my-auto">Membership Name</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <label class="col-md-4 control-label my-auto">Price</label>
                      <div class="col-md-8">
                   ...
                   <div class="form-group">
                    <div class="row mt-2">
                      ...
                      <div class="custom-control custom-radio mb-3 ml-2 my-auto">
                        <input type="radio" class="custom-control-input col-md-2 plan" name="plan" id="membership" value="1" required="">
                        <label class="custom-control-label p-3px ml-2" for="membership">Membership</label>
                      </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <label class="col-md-4 control-label mt-3">Duration</label>
                      <div class="col-md-8">
                        <input type="text" placeholder="Number  Day/Week/Month/Year" name="duration" onkeypress="return isAlphaNumeric(event)" class="form-control" required><span class="text-muted">Eg: 1 Month</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <label class="col-md-4 control-label mt-3">Short Description</label>
                      <div class="col-md-8">
