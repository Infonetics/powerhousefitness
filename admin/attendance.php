  ...
  <div class="main-content">
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Manage Attendance</a>
    <!-- Header -->
                    ...
                    <form class="form-inline">
                      <div class="col-md-3">
                        <div class="row ">
                          ...
                          <select name="cu_trainer_sel" id="cu_trainer_sel" class="form-control col-sm-8" onchange="getcate(this.value)">
                      ...
                      <!-- <div class="col-md-4 ">
                        <div class="row">
                          <div class="form-group col-sm-10">
                            <input type="text" class="form-control "  name="" placeholder="Search name etc."><button class="form-control col-sm-2"><i class="fa fa-search"></i></button>
                          </div>
                        </div>
                      </div> -->
    ...
    function getcate(val)
    {
      alert(val);
         $.ajax({  
                url:"fetch.php",  
                method:"POST",  
                data:{emp_or_cust:val},  
                dataType:"html",  
                success:function(data){  
                     $('#emp_cust_list').html(data);
                }  
           });  
    }
