...
<body class="">
  ...
  <div class="main-content">
      ...
      <div class="row">
        <div class="col">
          <div class="card shadow">
            ...
            {
            	 extract($_POST);
                $sql="INSERT INTO `".DB_PREFIX."`.`tbl_taxrate` (`tax_name`,`tax_rate`,`created_on`) values ('".trim($tax_name)."','".trim($tax_rate)."', NOW() )";
	             //echo $sql;exit;
	...
	if(isset($_POST['update']))
      {
      extract($_POST);
      $ql= "UPDATE `".DB_PREFIX."`.`tbl_taxrate` SET `tax_name`= '".trim($tax_name_up)."',`tax_rate`= '".trim($tax_rate_up)."' WHERE `taxrate_id`='$taxrate_id'";
            //echo $ql;exit;
