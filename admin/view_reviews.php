...
if(isset($_POST['update']))
{
  ...
  include("image_validation.php");
            ...
            $ql= "UPDATE `".DB_PREFIX."`.`tbl_testimonials` SET `customer_name`= '".trim($customer_name)."',`customer_position`= '".trim($position)."',`description`='".trim(addslashes($description))."',`image`='".trim($image)."' WHERE `testimonials_id`='$testimonials_id'";
           //echo $ql;exit;
...
?>
                   <?php 
                                           ...
                                           $sql = "SELECT * FROM `".DB_PREFIX."`.`tbl_testimonials`";
