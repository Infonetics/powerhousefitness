<?php session_start();
 include('include/config.php');
  ...
  { 
             ...
             {  
                  $query = "SELECT * FROM tbl_testimonials WHERE testimonials_id = '".$_POST["testimonials_id"]."'"; 
             ...
             if(isset($_POST['del_testimonials_id']))
              {
                    $query = "DELETE  FROM tbl_testimonials WHERE testimonials_id = ".$_POST['del_testimonials_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_trainer WHERE trainer_id = '".$_POST["trainer_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_trainer_id']))
              {
                    $query = "DELETE  FROM tbl_trainer WHERE trainer_id = ".$_POST['del_trainer_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_membership WHERE membership_id = '".$_POST["membership_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_membership_id']))
              {
                    $query = "DELETE  FROM tbl_membership WHERE membership_id = ".$_POST['del_membership_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_workout_classes WHERE workout_classes_id = '".$_POST["workout_classes_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_workout_classes_id']))
              {
                    $query = "DELETE  FROM tbl_workout_classes WHERE workout_classes_id = ".$_POST['del_workout_classes_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_customer WHERE customer_id = '".$_POST["customer_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_customer_id']))
              {
                    $query = "DELETE  FROM tbl_customer WHERE customer_id = ".$_POST['del_customer_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {   
                  $query = "SELECT c.*,tr.`fname` as tfname FROM tbl_customer c
             ...
             { 
                  $query = "SELECT *,tr.`fname` as tfname,tr.`lname` as tlname,c.`fname` as cfname FROM tbl_customer_pt cpt
            ...
            {   
              ...
              $query= "UPDATE `tbl_customer_pt` SET ";
            ...
            {   
              ...
              $query= "UPDATE `tbl_customer_membership` SET `customer_membership_expiry_date`='".$_POST["cm_adj_date"]."'
            ...
            {  
              $sql = "INSERT INTO tbl_holyday (holiday_event, holiday_date,created_on)
             ...
             {  
                  $query = "SELECT * FROM tbl_holyday WHERE holiday_id = '".$_POST["holiday_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
              ...
              {
                   $query= "UPDATE `tbl_holyday` SET `holiday_event`= '".$_POST["holiday_event_edit"]."',`holiday_date`= '".$_POST["holiday_date_edit"]."',`last_modified`=NOW() WHERE `holiday_id`='".$_POST['holiday_update']."'";
                    // echo $query; exit;
                    $con->query($query);
                    echo "Updated";
              }
              ...
              {
                    $query = "DELETE  FROM tbl_holyday WHERE holiday_id = ".$_POST['del_holiday_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
            ...
            /*.....Create holiday ends .......*/
             ...
             {  
                  $query = "SELECT * FROM tbl_gallery WHERE gallery_id = '".$_POST["gallery_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_gallery_id']))
              {
                    $query = "DELETE  FROM tbl_gallery WHERE gallery_id = ".$_POST['del_gallery_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_enquiry WHERE enquiry_id = '".$_POST["enquiry_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_enquiry_id']))
              {
                    $query = "DELETE  FROM tbl_enquiry WHERE enquiry_id = ".$_POST['del_enquiry_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_expense WHERE expense_id = '".$_POST["expense_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_expense_id']))
              {
                    $query = "DELETE  FROM tbl_expense WHERE expense_id = ".$_POST['del_expense_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             if(isset($_POST['del_id']))
              {
                    $query = "DELETE  FROM admin WHERE id = ".$_POST['del_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_banner WHERE banner_id = '".$_POST["banner_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_banner_id']))
              {
                    $query = "DELETE  FROM tbl_banner WHERE banner_id = ".$_POST['del_banner_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_taxrate WHERE taxrate_id = '".$_POST["taxrate_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_taxrate_id']))
              {
                    $query = "DELETE  FROM tbl_taxrate WHERE taxrate_id = ".$_POST['del_taxrate_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
             ...
             {  
                  $query = "SELECT * FROM tbl_discount WHERE discount_id = '".$_POST["discount_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  echo json_encode($row);  
             }  
             if(isset($_POST['del_discount_id']))
              {
                    $query = "DELETE  FROM tbl_discount WHERE discount_id = ".$_POST['del_discount_id'];
                    echo $query;
                    $con->query($query);
                    echo "deleted";
              }
              ...
              {  
                  $query = "SELECT duration FROM tbl_membership WHERE membership_id = '".$_POST["membership_plan_id"]."'"; 
                  $result = $con->query($query);
              ...
              {  
                    $query = "INSERT INTO  `tbl_customer_membership` SET `customer_id`='".$_POST["mupdate_customer_id"]."', `membership_id`='".$_POST["mplan"]."',`customer_membership_starting_date`='".$_POST["mstarting_date"]."',`customer_membership_expiry_date`='".$_POST["mexpiry_date"]."',`cm_plan`=1,`membership_date`=NOW(),`membership_paid_status`='2',`customer_membership_status`=1 "; 
                    $con->query($query);
                    $customer_membership_id=mysqli_insert_id($con);
                    
                    $query = "INSERT INTO  `tbl_mp_payment` SET `mp_payment_customer_membership_id`='".$customer_membership_id."',`mp_payment_paid_status`='2',`mp_payment_date`=NOW()"; 
                    $con->query($query);
                    $query = "SELECT name,price FROM tbl_membership WHERE membership_id = '".$_POST["mplan"]."'"; 
                    $result = $con->query($query);
                    $row = mysqli_fetch_array($result);

                    $check_receiptno="PHF".date('dmy');
                    $queryy = "SELECT receipt_no FROM tbl_total WHERE receipt_no LIKE '".$check_receiptno."%' ORDER BY  receipt_no DESC limit 0,1 "; 
            ...
            if(isset($_POST["mdiscount_id"]))  
             {  
                  $query = "SELECT * FROM tbl_discount WHERE discount_id = '".$_POST["mdiscount_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
             ...
             {  
                  $query = "SELECT * FROM tbl_taxrate WHERE taxrate_id = '".$_POST["mtaxrate_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  $amt=$_POST["mnet_total"];
             ...
             if(isset($_POST["mp_update_customer_id"])){
               ...
               $_SESSION['mp_customer_membership_id']=$_POST["mp_customer_membership_id"];
                foreach($_POST['total_details'] as $key => $total){
                  $query = "INSERT INTO  `tbl_total` SET `customer_id`='".$_POST["mp_update_customer_id"]."',`mp_customer_membership_id`='".$_POST["mp_customer_membership_id"]."', `receipt_no`='".$_POST["mp_receipt_no"]."',";
                ...
                $query = "INSERT INTO  `tbl_mp_cheque` SET `mp_cheque_customer_membership_id`='".$_POST["mp_customer_membership_id"]."', `mp_cheque_no`='".$_POST['cheque']['cheque_no']."',`mp_accnt_no`='".$_POST['cheque']['acc_no']."', `mp_cheque_date`='".$_POST['cheque']['cheque_date']."', `date_added`=NOW()";
                $con->query($query); 
                }
                 if(isset($_POST['card'])){
                $query = "INSERT INTO  `tbl_mp_card` SET `mp_card_customer_membership_id`='".$_POST["mp_customer_membership_id"]."', `mp_card_no`='".$_POST['card']['card_no']."',`mp_card_holder`='".$_POST['card']['mholder_name']."', `mp_card_expdate`='".$_POST['card']['mcard_exp_date']."', `mp_card_date_added`=NOW()";
                $con->query($query); 
                  }
                 $query = "INSERT INTO  `tbl_mp_payment` SET `mp_payment_customer_membership_id`='".$_POST["mp_customer_membership_id"]."',`mp_payment_paid_status`='3',`mp_payment_type`='".$_POST["mp_payment_type"]."',`mp_payment_date`=NOW()";
                 $con->query($query); 
                $query = "UPDATE `tbl_customer_membership` SET `membership_paid_status`='3' WHERE `customer_id`='".$_POST["mp_update_customer_id"]."' AND `customer_membership_id`='".$_POST["mp_customer_membership_id"]."'";
                $con->query($query); 
             ...
             /*..... update PT plan on manage payment page starts ...*/
              ...
              {  
                  $query = "SELECT duration FROM tbl_membership WHERE membership_id = '".$_POST["pt_plan_id"]."'"; 
                  $result = $con->query($query);
                  while($row = $result->fetch_assoc()) 
                  {   
                    $duration=$row['duration'];
            ...
            if(isset($_POST["ptdiscount_id"]))  
             {  
                  $query = "SELECT * FROM tbl_discount WHERE discount_id = '".$_POST["ptdiscount_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
             ...
             {  
                  $query = "SELECT * FROM tbl_taxrate WHERE taxrate_id = '".$_POST["pttaxrate_id"]."'"; 
                  $result = $con->query($query);  
                  $row = mysqli_fetch_array($result);  
                  $amt=$_POST["ptnet_total"];
             ...
             if(isset($_POST["pt_update_customer_id"])){
               ...
               $_SESSION['customer_pt_id']=$_POST["customer_pt_id"];
                foreach($_POST['total_details'] as $key => $total){
                  $query = "INSERT INTO  `tbl_total` SET `customer_id`='".$_POST["pt_update_customer_id"]."',`customer_pt_id`='".$_POST["customer_pt_id"]."', `receipt_no`='".$_POST["pt_receipt_no"]."',";
                  $query .="`title_text`='".$key."', `total_amount`='".$total."',";
                  $query .="`total_payment_date`=NOW(),sort_order= '".$cnt."'";//echo $query;
                  $con->query($query); 
                  $cnt++;
                 ...
                 $query = "INSERT INTO  `tbl_pt_cheque` SET `pt_cheque_customer_pt_id`='".$_POST["customer_pt_id"]."', `pt_cheque_no`='".$_POST['ptcheque']['ptcheque_no']."',`pt_accnt_no`='".$_POST['ptcheque']['ptacc_no']."', `pt_cheque_date`='".$_POST['ptcheque']['ptcheque_date']."', `pt_date_added`=NOW()";
                $con->query($query); 
                }
                 if(isset($_POST['ptcard'])){
               $query = "INSERT INTO  `tbl_pt_card` SET `pt_card_customer_pt_id`='".$_POST["customer_pt_id"]."', `pt_card_no`='".$_POST['ptcard']['ptcard_no']."',`pt_card_holder`='".$_POST['ptcard']['ptholder_name']."', `pt_card_expdate`='".$_POST['ptcard']['ptcard_exp_date']."', `pt_card_date_added`=NOW()";
                $con->query($query); 
                  }
                 $query = "INSERT INTO  `tbl_pt_payment` SET `pt_payment_customer_pt_id`='".$_POST["customer_pt_id"]."',`pt_payment_paid_status`='3',`pt_payment_type`='".$_POST["pt_payment_type"]."',`pt_payment_date`=NOW()";
                 $con->query($query); 
              
                 $query = "UPDATE `tbl_customer_pt` SET `pt_paid_status`='3'WHERE `customer_id`='".$_POST["pt_update_customer_id"]."' AND `customer_pt_id`='".$_POST["customer_pt_id"]."'";
                 $con->query($query); 
             } 
             /* PT paid button tbl total table ends*/
             if(isset($_POST["ptcustomer_id"]))  
             {  
               $query="SELECT c.*,cm.*,m.`membership_id`,m.`name` FROM `tbl_customer` c
