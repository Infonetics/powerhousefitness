                  ...
                  <div>
                    <?php include("include/config.php");
                         $query = "SELECT * FROM `tbl_customer_membership` cm 
                          ...
                          left join `tbl_pt_payment` ptp on(ptp.`pt_payment_customer_pt_id`=cm.`customer_membership_id`)
                          left join `tbl_total` t on(t.`mp_customer_membership_id`=cm.`customer_membership_id`)
                          WHERE cm.`customer_membership_id` = '".$_SESSION['pt_customer_membership_id']."' ORDER BY `pt_payment_id` DESC"; 
                      ...
                      <tbody>
                        <?php 
                         $query = "SELECT * FROM `tbl_customer_membership` cm 
                          ...
                          left join `tbl_total` t on(t.`mp_customer_membership_id`=cm.`customer_membership_id`)
                          WHERE cm.`customer_membership_id` = '".$_SESSION['pt_customer_membership_id']."' "; 
                          $result = $con->query($query);  
                          ...
                          $query="SELECT * FROM `tbl_total` WHERE `mp_customer_membership_id`= '".$_SESSION['pt_customer_membership_id']."' ORDER BY `sort_order` ASC "; 
                          $result = $con->query($query); 
