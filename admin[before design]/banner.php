...
include("image_validation.php");
            ...
            $ql= "UPDATE `tbl_banner` SET `banner_title`= '$banner_title',`text1`= '$text1',`text2`='$text2',`text3`='$text3',`image`='$image' WHERE `banner_id`='$banner_id'";
            // echo $ql;exit;
          ...
          <div class="card shadow">
            ...
            if(isset($_POST["btn_banner"]))
            {
               ...
               else
               {
                    ...
                    $sql="INSERT INTO tbl_banner (`banner_title`,`text1`,`text2`,`text3`,`image`,`created_on`) values ('$banner_title','$text1','$text2','$text3','$image',NOW())";
