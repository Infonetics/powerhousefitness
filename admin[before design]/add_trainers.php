                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="tel" placeholder="Contact No." name="contact" class="form-control"  maxlength="13" onkeypress="return isNumber(event)" required><!-- pattern="[0-9]{4}-[0-9]{4}-[0-9]{2}" -->
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
