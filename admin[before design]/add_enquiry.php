  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row">
        ...
        $sql = "INSERT INTO  tbl_enquiry (cust_name, mobile, email,  address,dob,age,gender, height_feet,height_inch,weight,occupation,  reference,  goal,  weight_loss,weight_gain,exercise,type,where_gym,gym_time,package_offer,remark,package_amount,enquiry_date,follow_date,created_on)
                                               ...
                                               <br>
                                                    <div class="row">
                                                      ...
                                                      <div class="col-md-4">
                                                        ...
                                                        <div class="custom-control custom-radio mb-3">
                                                          <input class="custom-control-input" id="test18" name="goal" value="Injury Rehabilitation" type="radio">
                                                          <label class="custom-control-label p-3px" for="test18">Injury Rehabilitation</label>
                                                        </div>
                                                        <div class="custom-control custom-radio mb-3">
                                                ...
                                                <label for="test27">Gym</label>
                                                  ...
                                                  <label for="test31">Spinning</label>
                                                    ...
                                                    <div class="custom-control custom-radio mb-3 ml-3">
                                                        ...
                                                        <div class="custom-control custom-radio mb-3 ml-3">
                                                          <input class="custom-control-input" id="test30" name="exercise_type" value="Spinning" type="radio">
                                                          <label class="custom-control-label p-3px" for="test30">Spinning</label>
                                                        </div>
