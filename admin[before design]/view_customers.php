             ...
             <div class="modal-content">  
                  ...
                  <div class="modal-body p-2" id="customer_update">  
                                     <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="insert_form">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-4 control-label">Guardian Contact</label>
                                                <div class="col-md-8">
                  ...
                  <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="insert_form">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="row">
                            ...
                            <label class="col-md-6 label2 font-weight-bold" id="vcontact" name="vcontact"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <label name="vemail" id="vemail" class="font-weight-bold control-label col-md-8 label2"></label>
                      </div>
                    </div>             
