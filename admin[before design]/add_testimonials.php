  ...
  <div class="main-content">
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">Add Testimonials</a>
    <!-- Header -->
          ...
          <div class="card shadow">
            ...
            if(isset($_POST["btn_customer"]))
            {
               ...
               else
               {
                    ...
                    $sql="INSERT INTO tbl_testimonials (`customer_name`, `customer_position`, `description`,`image`,`created_on`) values ('".trim($customer_name)."','".trim($position)."','".trim(addslashes($desc))."','".trim($image)."',NOW())";
                    //echo $sql;exit;
