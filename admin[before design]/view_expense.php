            ...
            if(isset($_POST['update']))
             ...
             // include("image_validation.php");
               ...
               // {
                  ...
                  $ql= "UPDATE `tbl_expense` SET `item_name`= '$item_name',`purchase_shop_name`= '$purchase_shop_name',`purchase_date`='$purchase_date',`price`='$price',`bill`='$image',`last_modified`= NOW() WHERE `expense_id`='$expense_id'";
                      // echo $ql;exit;
                    // ,last_modified= NOW()
